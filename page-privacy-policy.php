...
<div class="privacy-policy-alignment">

    <!-- Privacy Policy Content -->
    <div class="privacy-policy-content">
        <?php while (have_posts()) : the_post(); ?>

            <article id="page-<?php the_ID(); ?>" <?php post_class('privacy-policy-article'); ?>>
    ...
    <section class="privacy-policy-contact">
        <h2 class="privacy-policy-contact-title">Contact Me</h2>

        <p class="privacy-policy-contact-intro">
            If you have any privacy questions, concerns, or data requests, you can reach me at:
        </p>

        <div class="privacy-policy-contact-info">
            <?php
            // Get contact info from customizer
            $contact_email = get_theme_mod('privacy_contact_email', 'your-email@example.com');
            $discord_link = get_theme_mod('privacy_discord_link', '');
            ?>

            <!-- Email -->
            <div class="privacy-policy-contact-item">
            ...
            <?php if (!empty($discord_link)) : ?>
                <div class="privacy-policy-contact-item">
                    ...
                    <a href="<?php echo esc_url($discord_link); ?>" class="contact-link" target="_blank" rel="noopener noreferrer">
                        Discord for privacy related question.
                    </a>
                </div>
            <?php endif; ?>
        </div>
